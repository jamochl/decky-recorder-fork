...
class Plugin:
    ...
    async def attach_mic(self):
        ...
        get_cmd_output(f"pactl load-module module-ladspa-sink sink_name={self._echoCancelledMicName}_raw_in sink_master={self._echoCancelledMicName} label=noise_suppressor_mono plugin={denoise_extracted_file_path} control=40,20,0,0,0")
